  ...
  return (
    <div>
      <ol className='list-decimal space-y-5 '>
        ...
        <li>Select the frame length and hop length from a particular audio file and obtain multiple sets of reading by changing the above parameters associated with the audio file.</li>
        <li>Compute the Root Mean Square and Zero Crossing rate feature for all the different frames in an audio file.</li>
        <li>The above steps from Step 1 to Step 6 needs to be repeated for all the 10 audio files.</li>
      </ol>
    </div>
  )
}
