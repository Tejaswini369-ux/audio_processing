...
const Theory = () => {
  return (
    <div className='leading-loose text-sm'>
      ...
      <img src ={adaptiveequalization} alt='adaptiveequalization'/><br />
      ...
      <p>
        ...
        <img src={convergence} alt='convergence'/>
      </p><br />
      ...
      <img src={blockdiagram} alt='blockdiagram' />
      <p>
      ...
      <p>Commonly used filters can be divided into three kinds: FIR (Finite Impulse Response) filter, IIR (Infinite Impulse Response) filter, and adaptive filter. 
        ...
        <p align='center'><img src={lms2} alt='lms2'/></p>
