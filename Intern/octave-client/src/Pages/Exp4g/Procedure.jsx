...
const Procedure = () => {
  return (
    <div>
      ...
      <li>Enter the value of split frequency from the user. Typical values are in the range of 500 to 10000 Hz.</li>
      ...
      <li>Compute the values of the <b>Band Energy ratio</b>.</li>
      <li>Lastly plot the <b>Spectrograms</b> with frequency values in log scale along with the <b>Band Energy ratio</b> values corresponding to the selected audio file in <b>Step 3</b>.</li>
