function AR_process(n_steps, p, phi, sigma, uniqueIdentifier)
    ...
    subplot(2, 1, 1), pos1 = get(gca, 'Position');
    set(gca, 'Position', [pos1(1), pos1(2)-0.05, pos1(3), pos1(4)]);
    subplot(2, 1, 2), pos2 = get(gca, 'Position');
    set(gca, 'Position', [pos2(1), pos2(2)-0.05, pos2(3), pos2(4)]);
